      ...
      <DialogContent className="p-0 overflow-y-auto" flex flex-col h="850px" min-w="780px">
        ...
        <div mt-4 mx-0 px="20px">
          <ToggleGroup defaultValue={'bold'} flex items-center className="gap-0" mx-0 w-full type="single">
            <ToggleGroupItem className="data-[state=on]:bg-primary data-[state=on]:text-white data-[state=on]:border-transparent !data-[state=off]:border" rounded-r-none p-0 w-full mx-0 value="bold" aria-label="Toggle">
              С начало дешедешевле
            </ToggleGroupItem>
            <ToggleGroupItem className="data-[state=on]:bg-primary data-[state=on]:text-white data-[state=on]:border-transparent !data-[state=off]:border" rounded-l-none p-0 w-full mx-0 value="italic" aria-label="Toggle">
              С начначала дорогие
            </ToggleGroupItem>
          </ToggleGroup>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button w-full flex items-center justify-between border-t-none rounded-t-none variant="outline">
                1 гость
          ...
          <div flex justify-start items-center >
            <ToggleGroup defaultValue="5" type="single">
              <ToggleGroupItem className="flex items-center gap-2 data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
                value="5" aria-label="Toggle bold">
                <StarIcon2 />
                5
              </ToggleGroupItem>
              <ToggleGroupItem className="flex items-center gap-2 data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
                value="4" aria-label="Toggle bold">
                <StarIcon2 />
                4
              </ToggleGroupItem>
              <ToggleGroupItem className="flex items-center gap-2 data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
                value="3" aria-label="Toggle bold">
                <StarIcon2 />
                3
              </ToggleGroupItem>
              <ToggleGroupItem className="flex items-center gap-2 data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
                value="2" aria-label="Toggle bold">
                <StarIcon2 />
                2
              </ToggleGroupItem>
              <ToggleGroupItem className="flex items-center gap-2 data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
                value="1" aria-label="Toggle bold">
                <StarIcon2 />
                1
              </ToggleGroupItem>
            </ToggleGroup>
          ...
          <p text-lg not-italic font-normal mt-2 leading-6>Спальни</p>
          <ToggleGroup defaultValue="!need" type="single" className="flex justify-start gap-2 mt-[10px]">
            <ToggleGroupItem className="data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
              value="!need" aria-label="Toggle bold">
              Неважно
            </ToggleGroupItem>
            <ToggleGroupItem className="data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
              value="1" aria-label="Toggle bold">
            ...
            <ToggleGroupItem className="data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
              value="6" aria-label="Toggle bold">
              6
            </ToggleGroupItem>
            <ToggleGroupItem className="data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
              value="7" aria-label="Toggle bold">
              7+
            </ToggleGroupItem>
          </ToggleGroup>
          <p text-lg not-italic font-normal mt-2 leading-6>Кровати</p>
          <ToggleGroup defaultValue="!need" type="single" className="flex justify-start gap-2 mt-[10px]">
            <ToggleGroupItem className="data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
              value="!need" aria-label="Toggle bold">
              Неважно
          ...
          <p text-lg not-italic font-normal mt-2 leading-6>Ванные</p>
          <ToggleGroup defaultValue="!need" type="single" className="flex justify-start gap-2 mt-[10px]">
            <ToggleGroupItem className="data-[state=on]:bg-primary data-[state=on]:border-transparent data-[state=on]:text-white rounded-full px-4 py-2 border"
              value="!need" aria-label="Toggle bold">
              Неважно
