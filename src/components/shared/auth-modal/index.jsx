        ...
        <div className="" >
            <div >
              <InputMask
                ...
                value={phone}
                onChange={(e) => setPhone(e.target.value)} font="400" text="14px" leading="20px" p="12px" rounded="10px" w-full border outline-none sm-w="317px" className=" xl:w-[482px] xl:mt-[20px]" >
                {(inputProps) => <input {...inputProps} type="text" placeholder="Номер телефона" />}
              </InputMask>
            </div>

            <p text="#454545" font="400" leading="20px" mt="20px" className=" text-[14px] sm:text-center  sm:text-[14px] xl:text-sm  xl:font-normal xl:leading-5 xl:text-start"   >
          ...
          <button my="20px" text="#fff" text-sm bg="#03559E" w-full  rounded="10px" py="10px" className=" sm:w-[317px] xl:w-full xl:py-[12px] xl:my-[20px]" sm:mx-auto >Продолжить</button>
          ...
          <div flex flex-col gap="16px" mt="20px"  w-full  className="sm:w-[317px] sm:mx-auto xl:w-[482px] xl:gap-[12px] ">
