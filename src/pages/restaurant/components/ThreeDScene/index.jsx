...
const ChairModel = ({ position }) => {
  const gltf = useLoader(GLTFLoader, "/public/chair.glb"); // Ensure this path is correct
...
const TableModel = () => {
  const gltf = useLoader(GLTFLoader, "/public/table.glb"); // Ensure this path is correct
