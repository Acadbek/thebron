    ...
    <>
      ...
      <div grid grid-cols-12 max-w="1470px" mx-auto>
        <div col-span-6>
          ...
          <p text-black text-2xl font-bold leading-9 mt="40px">Ваша поездка</p>
          ...
          <p text-black text-2xl font-bold leading-9 mt="40px">Варианты оплаты</p>
          <RadioGroup defaultValue="1">
            <Label htmlFor="r1" className="flex  items-center space-x-2 justify-between px-[12px] py-[14px] border rounded-t-md">
              <div flex flex-col gap="8px">
                <Label htmlFor="r1"><span text-black text-xl not-italic font-bold leading-7>Оплатите посностью</span></Label>
                <Label htmlFor="r1"><span text-black text-lg not-italic font-normal leading-6>Уплатите полную сумму ({formatNumber(bron?.amount)})</span></Label>
              </div>
              <RadioGroupItem className="w-[30px] h-[30px]" value="1" id="r1" />
            </Label>
            <Label htmlFor="r2" className="flex items-center justify-between space-x-2 px-[12px] py-[14px] border">
              <div flex flex-col gap="8px">
                <Label htmlFor="r2"  text-black text-xl not-italic font-bold leading-7>Оплатите часть сейчас, а остаток внесите позже</Label>
                <Label htmlFor="r2"><span text-black text-lg not-italic font-400 leading-6>000 000 сумм к оплате сегодня, 000 000сумм- 24 март.2024 г. Без дополнительных сборов.   Подробнее</span></Label>
              </div>
              <RadioGroupItem className="w-[30px] h-[30px]" value="2" id="r2" />
            </Label>
          </RadioGroup>
          <div border-b mt="36px"></div>
          <p text-black text-2xl font-bold leading-9 mt="48px">Чем оплатить</p>
        </div>
        <div col-span-6>
          <div sticky w-full top-0>
            <Card className="max-w-[490px] ml-[170px]" pt="32px">
              <CardContent w-full>
                  ...
                  <div>
                    <h2 text-black text-xl not-italic font-bold leading-6>{resort?.name}</h2>
                    <p text-black text="13px" not-italic font-normal leading-6 mt='6px'>{resort?.location_name}</p>
                ...
                <div border-b mt="24px"></div>
                <p className="text-[24px] mt-[24px] text-[#222]" not-italic font-bold leading-9>Детализация цены</p>
                <ul>
                  <li flex items-center justify-between mt="14px" text="#222" text-lg not-italic font-normal leading-6>
                    <span>000 000сумм х 5 ночей</span>
                    <span>000 000 сумм</span>
                  </li>
                  <li flex items-center justify-between mt="8px" text="#222" text-lg not-italic font-normal leading-6>
                ...
                <p flex items-center justify-between mt='24px'>
                  <span className="text-[#222] text-xl not-italic font-bold leading-7" >Итого(сум)</span>
                  <span className="text-[#222] text-xl not-italic font-bold leading-7" >000 000сум</span>
                </p>
              </CardContent>
            </Card>
          </div>
